...
from textaccounts.core import resolve_profile, compute_env, active_profile_from_env
...
def active_profile() -> str | None:
    """Return the name of the active profile in *this shell* (derived from
    $CLAUDE_CONFIG_DIR), or None if no profile matches."""
    registry = load_registry()
    p = active_profile_from_env(registry)
